   ...
   "outputs": [
    {
     ...
     "text": [
      "\n",
      "\n",
      "Honoré de BalzacLes Deux PoètesIllusions perdues, Vve A. Houssiaux, 1874 (p. 1-119).Un grand homme de province à Paris  ►collectionLes Deux PoètesHonoré de BalzacVve A. Houssiaux1874ParisTLes Deux PoètesBalzac - Œuvres complètes, éd. Houssiaux, 1874, tome 8.djvuBalzac - Œuvres complètes, éd. Houssiaux, 1874, tome 8.djvu/91-119 \n",
      "\n",
      "\n",
      "\n",
      "\n",
      ...
      "\n",
      "— Un drôle de père, allez ! reprit Courtois. Il fait, dit-on, tout vendre chez son fils, et il a pour plus de deux cent mille francs de bien, sans compter son esquipot !\n",
      "\n",
      "Lorsque l’âme et le corps ont été brisés dans une longue et douloureuse lutte, l’heure où les forces sont dépassées est suivie ou de la mort ou d’un anéantissement pareil à la mort, mais où les natures capables de résister reprennent alors des forces. Lucien, en proie à une crise de c\n"
     ]
    }
   ],
   "source": [
